...
bool vtvl_msgs__msg__vehicle_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vtvl_msgs.msg._vehicle_state.VehicleState", full_classname_dest, 41) == 0);
  }
  vtvl_msgs__msg__VehicleState * ros_message = _ros_message;
  {  // header
  ...
  {  // attitude
    ...
    if (!geometry_msgs__msg__quaternion__convert_from_py(field, &ros_message->attitude)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * vtvl_msgs__msg__vehicle_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vtvl_msgs.msg._vehicle_state");
  ...
  {  // attitude
    PyObject * field = NULL;
    field = geometry_msgs__msg__quaternion__convert_to_py(&ros_message->attitude);
    if (!field) {
      return NULL;
    }
    {
