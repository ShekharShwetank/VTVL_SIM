...
#include "vtvl_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vtvl_msgs
cdr_serialize(
  const vtvl_msgs::msg::VehicleState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vtvl_msgs::msg::VehicleState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vtvl_msgs::msg::VehicleState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vtvl_msgs::msg::VehicleState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vtvl_msgs::msg::VehicleState *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_vtvl_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<vtvl_msgs::msg::VehicleState>()
{
  return &vtvl_msgs::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vtvl_msgs, msg, VehicleState)() {
  return &vtvl_msgs::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
