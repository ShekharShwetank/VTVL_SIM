...
#include "vtvl_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_c.h"
...
#include "vtvl_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // angular_velocity, velocity
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_vtvl_msgs
...
using _VehicleState__ros_msg_type = vtvl_msgs__msg__VehicleState;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vtvl_msgs
size_t get_serialized_size_vtvl_msgs__msg__VehicleState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleState__ros_msg_type * ros_message = static_cast<const _VehicleState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VehicleState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vtvl_msgs__msg__VehicleState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vtvl_msgs
size_t max_serialized_size_vtvl_msgs__msg__VehicleState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vtvl_msgs__msg__VehicleState;
    is_plain =
      (
...
static size_t _VehicleState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vtvl_msgs__msg__VehicleState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vtvl_msgs, msg, VehicleState)() {
